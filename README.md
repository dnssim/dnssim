...
“DNS-FullProtocolSimulator” was created by me, **DNS Simulator Researcher**, as part of my thesis research. Feel free to contact me for any help via [dnssimulator@gmail.com](mailto:dnssimulator@gmail.com).
...
4. In order to open another terminal for the environment first run `docker container ls`, look for “dnssim” docker name and copy the Docker ID ![alt text](https://github.com/dnssim/dnssim/blob/master/images/dockercontainerls.png) Run `docker exec -it <CONTAINER_ID> bash`
...
DNS Simulator: [https://github.com/dnssim/dnssim](https://github.com/dnssim/dnssim)
